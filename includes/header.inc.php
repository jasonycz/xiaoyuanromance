...
<!-- 			<a href="index.php"><img src="./images/logo.png" title="futura" /></a> -->
		...
		<div class="top-nav" >
			<ul>	
				...
				<li><a href="index.php?action=myFeeling">状态</a></li>
				<li><a href="index.php?action=recentActivity">活动</a></li>
				<li><a href="index.php?action=services">个人</a></li>
				<li><a href="index.php?action=price1">推荐</a></li>
				<li><a href="index.php?action=recentArticles">动态</a></li>
				<!-- <li><a href="#portfolio">应用</a></li> -->
				<li><a href="index.php?action=contact">分享</a></li>
				<li class="friend">	
							...
							if(count($_friend)==0){
								...
								echo $_html;
									...
									for($i=0;$i<$_select_num;$i++) {
										...
										echo "<tr>";
										echo "<td>{$_html['ta']}</td>";
										echo '<td><a href="friendMakeCenter.php" title="'.$_html['content'].'">'.$_html['content_html'].'</a></td>';
